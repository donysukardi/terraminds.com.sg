...
class Layout extends React.Component {
  render() {
    ...
    const [headerMenu, footerMenu] =
      menu[0].node.slug === "header-menu"
        ? [menu[0].node, menu[1].node]
        : [menu[1].node, menu[0].node];
      ...
      <div className={containerCls}>
        <Helmet defaultTitle={`Terra Minds`} titleTemplate={`%s | Terra Minds`}>
          ...
          <link
            ...
            type="image/png"
            sizes="230x230"
            href="/favicons/favicon-230x230.png"
          />
        ...
        <footer className="footer">
          ...
          <div className="footer__info">
            <div className="footer__info-section">
              Office: 73 Ubi Road 1 #09-62 Oxley Bizhub
              <br /> Singapore 408733
              <br />
              Lesson location: 1 Marine Parade Central #02-03 (Above McDonalds)
              <br /> Singapore 449408
            </div>
            <div className="footer__info-section">
              Tel:{" "}
              <a href="tel:+6569268757" className="link-silent">
                +65 6926 8757
              </a>{" "}
              /{" "}
              <a href="tel:+6598336282" className="link-silent">
                +65 9833 6282
              </a>
              <br />
              Email:{" "}
              <a href="mailto: info@terraminds.com.sg" className="link-silent">
                {" "}
                info@terraminds.com.sg
              </a>
            </div>
          </div>
...
const LayoutWithOptions = props => (
  <StaticQuery
    ...
    `}
    render={data => (
      <Layout {...props} menu={data.allWordpressWpApiMenusMenusItems.edges} />
    )}
  />
);
