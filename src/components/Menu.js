...
class Menu extends React.Component {
  ...
  render() {
    ...
    return (
      <nav
        key={key}
        className={`nav${this.state.supportsHover ? " supports-hover" : ""}`}
      >
        <ul className="nav__list">
                ...
                {hasSubMenu && (
                  <ul className={dropdownCls}>
                    {item.wordpress_children.map((child) => {
                      ...
                      const subSubMenuCls =
                        hasSubSubMenu &&
                        child.wordpress_children.every(
                          (x) => x.title.length <= 5
                        )
          ...
          <li className="nav__item nav__item--social">
            <a
              ...
              href="http://instagram.com/terra_minds"
              target="_blank"
              rel="noopener noreferrer"
            >
              <InstagramIcon className="nav__link-img" />
            </a>
          </li>
          <li className="nav__item nav__item--social">
            <a
              className="nav__link-btn"
              href="https://www.facebook.com/terra.minds/"
              target="_blank"
              rel="noopener noreferrer"
            >
